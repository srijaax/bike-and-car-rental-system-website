    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="https://media.coxhealth.com/images/car_and_bike.2e16d0ba.fill-760x400.png" style = "width:100px;height:50px" alt="image"/></a> </div>
        </div>
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@example.com">SaiSreekar@gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Service Helpline Call Us: </p>
              <a href="tel:+639079373999">+918074005639</a> </div>
...
echo "Welcome To Bike and car rental portal";
 } ?>
          </div>
        </div>
      </div>
...
foreach($results as $result)
	{
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
        ...
        <!-- <div class="header_search">
          ...
          <form action="#index.php/bok" method="get" id="header-search-form">
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="bike-listing.php">Car | Bike Listing</a>
